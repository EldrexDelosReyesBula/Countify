    ...
    renderAppShell() {
        document.querySelector('.app').innerHTML = `
            ...
            <header class="header">
                ...
                <h1 class="header-title" data-translate="app_title" onclick="window.location.href='/public/functions/treasure/owl.html'" style="cursor: pointer;">
                    Countify+
                </h1>
            ...
            <div id="wattBanner" class="watt-banner">
                ...
                <div class="watt-actions">
                    <button id="wattDecline" class="btn btn-outline haptic-link" data-translate="decline">Decline</button>
                    <button id="wattAccept" class="btn btn-primary haptic-link" data-translate="i_understand">I understand</button>
                </div>
            </div>
...
background: linear-gradient(145deg, rgba(255, 185, 185, 0.9), rgba(255, 130, 130, 0.8));
box-shadow:
    inset 2px 2px 4px rgba(255, 255, 255, 0.5),
    inset -4px -4px 6px rgba(255, 110, 110, 0.3),
...
"
class="drawer-item"
href="https://www.paypal.com/paypalme/EldrexDelosReyesBula?locale.x=en_US&country.x=PH"
target="_blank"
rel="noopener noreferrer"
>
<span class="material-icons drawer-item-icon" style="
    color: #FF4668;
    font-size: 24px;
    /* Removed translateY */
    display: flex;
...
<a style="text-decoration: none; color: var(--text-secondary);" class="drawer-item" href="/public/docs/privacy.html" target="_blank" rel="noopener noreferrer">
<span class="material-icons drawer-item-icon">lock</span>
<span data-translate="privacy_policy">Privacy Policy</span>
</a>

<a style="text-decoration: none; color: var(--text-secondary);" class="drawer-item" href="/public/docs/terms.html" target="_blank" rel="noopener noreferrer">
<span class="material-icons drawer-item-icon">description</span>
<span data-translate="terms_service">Terms of Service</span>
</a>

<a style="text-decoration: none; color: var(--text-secondary);" class="drawer-item" href="/public/license.html" target="_blank" rel="noopener noreferrer">
<span class="material-icons drawer-item-icon">gavel</span>
<span data-translate="license">License (LPSL v1.0)</span>
</a>

<div class="drawer-item">
<span class="material-icons drawer-item-icon">
        <img style="width: 100%; height: 100%;" src="/public/logo/countify.svg">
</span>
<span data-translate="version">Version</span> 2.1.0
    ...
    startVoiceInput() {
        ...
        try {
            ...
            this.showAlert(
                window.CountifyLanguage?.getTranslation('microphone_error') || 'Microphone Error',
                window.CountifyLanguage?.getTranslation('microphone_permission_denied') || 'Microphone permission was denied. Please enable microphone access in your browser settings.'
            );
            this.triggerHapticFeedback('error');
        }
    }
